...
const READS=new Set(['list_learning_leaderboard','is_admin_user','avp_is_admin','avp_chat_is_admin']);
...
function ttl(name){return (name==='is_admin_user'||name==='avp_is_admin'||name==='avp_chat_is_admin')?30000:1800}
