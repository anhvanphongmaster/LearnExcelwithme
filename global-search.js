(() => {
  const ITEMS = [
    ...
    {icon:'📖', title:'Tài liệu tham khảo', desc:'Sách Excel, Word, PowerPoint và tài liệu học thêm', url:'tai-lieu-tham-khao.html', type:'Tài liệu', keys:'sach combo tai lieu tham khao excel word powerpoint thu thuat'},
