...
function renderDashboard(){
 ...
 if(next){ct.textContent=next[1];cp.textContent=`Bạn đã hoàn thành ${courseDone}/6 chuyên đề. Tiếp tục bài này để tiến gần hơn tới hoàn thành lộ trình.`;cb.href=next[2];cb.textContent="Tiếp tục học →"}else if(pgDone<10){ct.textContent="Excel Playground";cp.textContent=`Lộ trình 6 chuyên đề đã hoàn thành. Còn ${10-pgDone} thử thách Playground để hoàn tất bộ thực hành.`;cb.href="playground.html";cb.textContent="Tiếp tục thực hành →"}else{ct.textContent="Bạn đang làm rất tốt 🎉";cp.textContent="Bạn đã hoàn thành lộ trình chính và 10 thử thách Playground. Hãy thử nâng điểm Quiz hoặc ôn lại các chuyên đề.";cb.href="practice-video.html";cb.textContent="Đi thực hành →"}
