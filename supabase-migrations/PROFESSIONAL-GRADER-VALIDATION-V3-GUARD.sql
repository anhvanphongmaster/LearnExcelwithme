-- Professional Track grader validation V3 guard
-- Applied to production 2026-09-09.
-- Publish requires validation produced by AVP_PRO_GRADER_V3 against the exact
-- current private Reference object, plus PASS=10 and both negative tests <7.
